                    ...
                    <div id="top" class="row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group h2">
                                <input name="pais" class="form-control"  type="text" placeholder="Pesquisar paises (deixe vazio para trazer todos)">
                            ...
                            <tbody>
          					<c:forEach var="paises" items="${lista}">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="ManterPaises.do?area=0&populacao=0&acao=Visualizar&id=${paises.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="ManterPaises.do?area=0&populacao=0&acao=Editar&id=${paises.id }">Editar</a>
